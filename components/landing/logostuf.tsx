...
export function LogoCarouselDemo() {
  return (
    <div className="space-y-8 py-24 mx-3 md:mx-15">
      <div className="mx-auto flex w-full max-w-screen-lg flex-col items-center space-y-8">
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-white leading-tight mb-4">
            بهترین ها در کنار ایکس ری Ai!
          </h2>


          <a className="text-white" href="https://www.newcult.co" target="_blank">
            <p >از همین الان به جمع کاربران پکسی بپیوندید</p>
          </a>
        </div>


      </div>
      {/* <div className="bg-white mx-auto rounded-4xl py-4 shadow-xl flex w-full max-w-screen-lg flex-col items-center space-y-8">   
